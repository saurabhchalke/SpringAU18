...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <p>Click on the button below to see the list of students in AU</p><br>
      <form method="get" action="/SaurabhServlet/StudentList">
      <button type="submit" class="btn btn-primary btn-lg">List of students</button>
      </form>
      </div>
